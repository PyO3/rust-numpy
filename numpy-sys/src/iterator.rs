...
pub type NpyIter_GetMultiIndexFunc = Option<unsafe extern "C" fn(iter: *mut NpyIter, outcoords: *mut npy_intp)>;
...
extern "C" {
    ...
    pub fn NpyIter_GetIterIndexRange(iter: *mut NpyIter, istart: *mut npy_intp, iend: *mut npy_intp);
    ...
    pub fn NpyIter_GetGetMultiIndex(iter: *mut NpyIter, errmsg: *mut *mut c_char) -> NpyIter_GetMultiIndexFunc;
    ...
    pub fn NpyIter_CreateCompatibleStrides(iter: *mut NpyIter, itemsize: npy_intp, outstrides: *mut npy_intp) -> c_int;
