...
impl PyArrayAPI {
    ...
    impl_api![50; PyArray_CopyInto(dest: *mut PyArrayObject, src: *mut PyArrayObject) -> c_int];
    impl_api![51; PyArray_CopyAnyInto(dest: *mut PyArrayObject, src: *mut PyArrayObject) -> c_int];
    ...
    // Min v2.0 impl_api![65; PyArray_Pack(descr: *mut PyArray_Descr, iter: *mut c_void, value: *mut PyObject) -> c_int];
    ...
    // Min v1.22 impl_api![304; PyDataMem_SetHandler(handler: *mut PyObject) -> *mut PyObject];
    // Min v1.22 impl_api![305; PyDataMem_GetHandler() -> *mut PyObject];
    // Min v2.0 impl_api![307; NpyDatetime_ConvertDatetime64ToDatetimeStruct(meta: *mut PyArray_DatetimeMetaData, dt: npy_datetime, out: *mut npy_datetimestruct) -> c_int];
    // Min v2.0 impl_api![308; NpyDatetime_ConvertDatetimeStructToDatetime64(meta: *mut PyArray_DatetimeMetaData, dts: *const npy_datetimestruct, out: *mut npy_datetime) -> c_int];
    // Min v2.0 impl_api![309; NpyDatetime_ConvertPyDateTimeToDatetimeStruct(obj: *mut PyObject, out: *mut npy_datetimestruct, out_bestunit: *mut NPY_DATETIMEUNIT,  apply_tzinfo: c_int) -> c_int];
    // Min v2.0 impl_api![310; NpyDatetime_GetDatetimeISO8601StrLen(local: c_int, base: NPY_DATETIMEUNIT) -> c_int];
    // Min v2.0 impl_api![311; NpyDatetime_MakeISO8601Datetime(dts: *mut npy_datetimestruct, outstr: *mut c_char, outlen: npy_intp, local: c_int, utc: c_int, base: NPY_DATETIMEUNIT, tzoffset: c_int, casting: NPY_CASTING) -> c_int];
    // Min v2.0 impl_api![312; NpyDatetime_ParseISO8601Datetime(str: *const c_char, len: pyo3::ffi::Py_ssize_t, unit: NPY_DATETIMEUNIT, casting: NPY_CASTING, out: *mut npy_datetimestruct, out_bestunit: *mut NPY_DATETIMEUNIT, out_special: *mut npy_bool) -> c_int];
    // Min v2.0 impl_api![313; NpyString_load(allocator: *mut npy_string_allocator, packed_string: *const npy_packed_static_string, unpacked_string: *mut npy_static_string) -> c_int];
    // Min v2.0 impl_api![314; NpyString_pack(out: *mut npy_packed_static_string) -> c_int];
    // Min v2.0 impl_api![315; NpyString_pack_null(allocator: *mut npy_string_allocator, packed_string: *mut npy_packed_static_string) -> c_int];
    // Min v2.0 impl_api![316; NpyString_acquire_allocator(descr: *const PyArray_StringDTypeObject) -> *mut npy_string_allocator];
    // Min v2.0 impl_api![317; NpyString_acquire_allocators(n_descriptors: usize, descrs: *const *mut PyArray_Descr, allocators: *mut *mut npy_string_allocator)];
    // Min v2.0 impl_api![318; NpyString_release_allocator(allocator: *mut npy_string_allocator)];
    // Min v2.0 impl_api![319; NpyString_release_allocators(length: usize, allocators: *mut *mut npy_string_allocator)];
    // Min v2.0 impl_api![361; PyArray_GetDefaultDescr(DType: *mut PyArray_DTypeMeta) -> *mut PyArray_Descr];
    // Min v2.0 impl_api![362; PyArrayInitDTypeMeta_FromSpec(DType: *mut PyArray_DTypeMeta, spec: *mut PyArrayDTypeMeta_Spec) -> c_int];
